    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".vibe__slider")) new swiper_core_Swiper(".vibe__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".vibe__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".vibe__swiper-button-prev",
                    nextEl: ".vibe__swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".card-slider__slider")) {
                let cardSwiper = new swiper_core_Swiper(".card-slider__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    navigation: {
                        prevEl: ".card-slider__swiper-button-prev",
                        nextEl: ".card-slider__swiper-button-next"
                    }
                });
                const sliderNavItems = document.querySelectorAll(".nav-cards__item");
